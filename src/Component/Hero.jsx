    ...
    <div className="md:flex justify-between px-5  md:w-[1100px] mx-auto py-28 text-black">
      <div>
        ...
        <h1 className="text-5xl font-bold">
          Save <span className="text-[#ff4c32] ">big</span> with our car rental
        </h1>
        <p className="text-gray-500 font-semibold py-6">
          To contribute to positive change and achive our sustainability <br />{" "}
          goals with many extraordinary
        </p>
        <div className="flex gap-5">
          <button className="btn btn-outline no-outline bg-[#ff4c32] text-white">Book Ride </button>
